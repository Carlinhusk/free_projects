...
<head>
    ...
    <style>
        ...
        .sidebar {
            height: 100%;
            /* VAI OCUPAR 100% DA ALTURA DA PAGINA */
            width: 0;
            /* ALTERA COM JAVASCRIPT */
            position: fixed;
            /* SERVE PRA MANTER NO LUGAR */
            z-index: 1;
            top: 0;
            left: 0;
            background-color: #111;
            overflow-x: hidden;
            /* DESABILIDA O SCROLL VERTICAL!!!!!!!!!!!!!!! */
            padding-top: 60px;
            transition: 0.5s;
        }
...
<script>
    function openNav() {
        ...
        document.getElementById("main").style.transition = "opacity 0.3s";
    ...
    function closeNav() {
        ...
        document.getElementById("main").style.transition = "opacity 0.7s";
    }
</script>
